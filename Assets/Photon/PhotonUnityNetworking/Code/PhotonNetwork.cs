...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        /// </summary>
        public static readonly int MAX_VIEW_IDS = 100000; // VIEW & PLAYER LIMIT CAN BE EASILY CHANGED, SEE DOCS
        ...
        public static int lastUsedViewSubIdStatic = 0;  // per room, the master is able to instantiate GOs. the subId for this must be unique too
